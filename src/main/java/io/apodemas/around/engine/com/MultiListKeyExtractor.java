 ...
 * @description:
 */
public class MultiListKeyExtractor<S, K> implements Function<List<S>, List<K>> {
    private List<KeyExtractor<S, K>> extractors;

    public MultiListKeyExtractor(List<KeyExtractor<S, K>> extractors) {
